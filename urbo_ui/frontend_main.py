...
def init(fastapi_app: FastAPI) -> None:
    ...
    def show():
        ...
        ui.html(
            "<h1><strong>URBO - Sustainability Tool for Urban Planning</strong></h1>"
        )
        ui.html(
            "<center>Select the Regional data to get insight on urban area planning </center>"
        )
        ...
        city_dropdown = ui.select(
            ["Pune", "Mumbai", "Chennai", "Bangalore", "New Delhi"]
        )
        ...
        ui.html(
            "<strong> Select keyword by which you want to filter the data </strong> </>"
        )
        keyword_dropdown = ui.select(
            ["Park", "Clinic", "School", "Playground"], clearable=True
        )
            ...
            if city and region and keyword and radius:
                ...
                try:
                    ...
                    response = requests.post(
                        "http://127.0.0.1:8000/aggregate-endpoint", json=payload
                    )
